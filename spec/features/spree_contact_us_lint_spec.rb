...
describe 'Contact Us page', js: true do
  ...
  it 'displays default formcontact form properly' do
    visit spree.contact_us_path
    within "form#new_contact_us_formcontact" do
      page.should have_selector "input#contact_us_formcontact_email"
      page.should have_selector "textarea#contact_us_formcontact_message"
      page.should_not have_selector "input#contact_us_formcontact_name"
      page.should_not have_selector "input#contact_us_formcontact_subject"
      page.should have_selector "input#contact_us_formcontact_submit"
    end
  end
  ...
  context 'with name and subject configuration' do
    ...
    it "displays an input for name and subject" do
      page.should have_selector "input#contact_us_formcontact_name"
      page.should have_selector "input#contact_us_formcontact_subject"
    end
    ...
    context "Submitting the form" do
      context "when valid" do
        before do
          fill_in 'Email', :with => 'test@example.com'
          fill_in 'Message', :with => 'howdy'
          fill_in 'contact_us_formcontact[name]', :with => 'Jeff'
          fill_in 'contact_us_formcontact[subject]', :with => 'Testing formcontact form.'
          click_button 'Submit'
        end
        ...
        it "The email should have been sent with the correct attributes" do
          ...
          mail.from.should == ['test@example.com']
          mail.subject.should match 'Testing formcontact form.'
          mail.to.should == ['contact@please-change-me.com']
          ActionMailer::Base.deliveries.size.should == 1
        end
      end
